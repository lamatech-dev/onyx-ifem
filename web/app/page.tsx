...
export default function Home() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      const [healthData, missionData, taskData, timelineData, reportData, organizationData, userData, contextLinkData,meetingData,conversationData] = await Promise.all([
        api<Ready>("/readyz"),
