...
export default function Home() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      const [healthData, missionData, taskData, timelineData, reportData, organizationData, userData, contextLinkData,meetingData,conversationData,fileData,approvalData,capacityData,forecastData,automationData,notificationData,synchronizationData,auditData] = await Promise.all([
        api<Ready>("/readyz"),
