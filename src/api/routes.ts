const COMMAND_CONTEXTS = new Set(["mission", "work", "timeline", "reporting-evidence", "organization", "identity-authority", "context", "meeting", "communication","file","approval","capacity","forecasting","automation","notification"]);
const RESOURCE_NAMES = new Set(["missions", "tasks", "timelines", "reports", "organizations", "users", "context-links", "meetings", "conversations","files","approvals","capacity-profiles","forecasts","automation-rules","notifications"]);
